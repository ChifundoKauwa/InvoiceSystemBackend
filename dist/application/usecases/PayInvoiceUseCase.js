...
let PayInvoiceUseCase = class PayInvoiceUseCase {
    invoiceRepo;
    eventBus;
    ...
    async execute(command) {
        ...
        try {
            ...
            throw new ApplicationExceptions_1.InvalidInvoiceStateError(invoice.getStatus(), "pay");
        }
